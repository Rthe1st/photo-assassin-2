...
export interface ServerUpdateSettingsMsg {
  gameState: SharedGame.ClientGame
}

export interface ServerBadSnipeMsg {
  gameState: SharedGame.ClientGame
...
export interface ServerStartMsg {
  gameState: SharedGame.ClientGame
}

export interface ServerResizeDone {
  imageId: number
  url: string
}

export interface ServerImageUploadDone {
  imageId: number
  url: string
}
